...
function renderVenuePage(venueId) {
  ...
  if (!document.getElementById('vp-styles')) {
    ...
    s.textContent = `
      ...
      @media(max-width:640px){.vp-rooms-grid{grid-template-columns:repeat(2,1fr) !important;gap:10px !important;}}
    `;
    document.head.appendChild(s);
  }
