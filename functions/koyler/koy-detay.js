// /koyler/koy-detay — Firebase'de köy yoksa HTTP 410 Gone döner
...
export async function onRequest(context) {
  ...
  try {
    const docUrl = `https://firestore.googleapis.com/v1/projects/assosu-kesfet/databases/(default)/documents/villages/${encodeURIComponent(id)}`;
...
<body>
  <div class="box">
    ...
    <a href="/koyler.html">Tüm Köyleri Keşfet →</a>
  </div>
</body>
</html>`;
