...
export async function onRequest(context) {
  ...
  try {
    ...
    // Firestore'da yok:
    //   Bot -> 410 Gone (SEO sinyali — silinen mekan dizinden dussun, soft 404 olmasin)
    //   Kullanici -> mekan-detay.html serve (client-side "Mekan Bulunamadi" UI)
    if (resp.status === 404) {
...
// 410 Gone — silinen/var olmayan mekanlar icin bot response (SEO: dizinden dussun)
function gone410() {
...
<body>
  <div class="box">
    ...
    <a href="/mekanlar">T\u00fcm Mekanlar\u0131 Ke\u015ffet \u2192</a>
  </div>
</body>
</html>`;
